...
const Footer = () => {
  return (
    <footer className="bg-[#8F3300] text-white ">
      <div className=" mx-auto px-5 max-w-[92rem]  lg:py-10 py-5">
        <div className="grid grid-cols-1  md:grid-cols-4 sm:grid-cols-2 md:gap-8 gap-4">
          <div className='text-center md:text-left flex flex-col gap-4 justify-between'>
            <Link to='/'>
              <p className=" font-bold md:text-2xl ">IJANR</p>
            ...
            <div className='flex flex-col justify-center md:items-start items-center md:text-left lg:text-base text-sm'>
              <div className='flex gap-3 items-center'>
                <FaEnvelope />
                <p>Email: <a href="mailto:editor@ijanr.com" className=" ">editor@ijanr.com</a></p>
              </div>
              <div className='flex gap-3 items-center'>
                <FaGlobe />
                <p>Website: <a href="https://ijanr.com/" className=" ">www.ijanr.com</a></p>
              </div>
              <div className=' p-3 '>
      ...
      <div className='grid lg:grid-cols-3 grid-cols-1  items-center  gap-2  md:py-3 pb-2'>
        ...
        <div className="text-center  md:text-base text-sm   ">
          <p>© 2025 <span className='hover:underline' > <Link to="/" target='_blank'>IJANR</Link> </span> . All Rights Reserved.</p>
        </div>
      </div>
    </footer>
  );
