                    ...
                    <section className="flex flex-col gap-5">
                        <section className="flex flex-col  md:gap-4 gap-2">
                            ...
                            <p className="text-justify md:text-base text-sm">
                                The International Journal of Advanced Nursing Research upholds a strict zero-tolerance policy against plagiarism. All submitted manuscripts are subject to thorough plagiarism checks to maintain the highest standards of academic integrity and ethical publishing.                            </p>                        </section>
                        ...
                        <section className="flex flex-col gap-2">
                            ...
                            <div className='flex flex-col gap-2  md:text-base text-sm'>
                                <div className='flex items-center gap-2'>
                                    <i className="fi fi-sr-right  text-[#8F3300]   flex items-center"></i>
                                    <p  ><span className='  font-semibold'>Direct Plagiarism:</span> Copying text verbatim without proper citation.</p>
                                </div>
                                <div className='flex items-center gap-2'>
                                    <i className="fi fi-sr-right  text-[#8F3300]   flex items-center"></i>
                                    <p  ><span className='  font-semibold'>Self-Plagiarism:</span> Reusing one’s own previously published work without disclosure.</p>
                                </div>
                                <div className='flex items-center gap-2'>
                                    <i className="fi fi-sr-right  text-[#8F3300]   flex items-center"></i>
                                    <p  ><span className='  font-semibold'>Mosaic Plagiarism:</span> Mixing copied phrases with original text without proper acknowledgment.  </p>
                                </div>
                                <div className='flex items-center gap-2'>
                                    <i className="fi fi-sr-right  text-[#8F3300]   flex items-center"></i>
                                    <p  ><span className='  font-semibold'>Improper Paraphrasing:</span> Rewording another author’s work without appropriate citation.</p>
                                </div>
