...
const Main = () => {
  ...
  return (
    <>
      ...
      {showScroll && (
        <button onClick={scrollToTop} className="fixed bottom-5 right-5 bg-white  text-[#8F3300] cursor-pointer border font-bold border-[#8F3300] p-3 rounded-full shadow-lg transition-opacity hover:bg-opacity-80"
        >
